...
export async function createCampaign(data) {
  ...
  const campaignInfoForDb = enrichCampaignInfoCountryFields(campaignInfo);
...
export async function updateCampaign(campaignId, updates) {
  ...
  if (normalized.campaignInfo != null) {
    normalized.campaignInfo = enrichCampaignInfoCountryFields(
      normalized.campaignInfo
    );
  }
  ...
  if (normalized.campaignInfo != null) {
    ...
    values.push(primaryRegionIsoFromCampaignInfo(normalized.campaignInfo));
  }
