...
const FIRST_VERSION_RULES = [
  ...
  '- When summarising the deliverables, you MUST cover every point stated in "clauses.deliverables": the publishing platform(s), the number of videos, the bio link duration, the ad code duration, and any usage-rights duration. Never drop a point for brevity, and never substitute a different platform.',
