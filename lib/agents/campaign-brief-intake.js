...
5. region 可多选；budget 为美元数字；commission 为百分比数字。用户说「纯产品置换/置换」时 commission=0 且 mode=commission_only（无需额外出现 0%）。
...
只返回 JSON：
{
  ...
  // 用户说「纯产品置换/置换/无固定费用+无佣金」时，应提取 mode=commission_only、commission=0。
