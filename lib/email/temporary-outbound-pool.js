...
export const TEMP_OUTBOUND_EMAIL_POOL = [
  ...
  // 自 op_contacts 扩充（均已配置 SMTP + IMAP）
  "annie@binfluencer.site",
  "annie@xinfluencer.cyou",
  "annie@xinfluencer.fun",
  "annie@xinfluencer.online",
  "annie@xinfluencer.pw",
  "annie@xinfluencer.shop",
  "annie@xinfluencer.site",
  "annie@xinfluencer.space",
  "annie@xinfluencer.store",
  "annie@xinfluencer.tech",
  "annie@xinfluencer.top",
  "annie@xinfluencer.uno",
  "annie@xinfluencer.website",
  "james@binfluencer.online",
];
