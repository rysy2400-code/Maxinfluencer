...
- 若 sampleSentAt 非空（样品已寄出）：禁止使用 “about to go out / shipment is going out / preparing to ship / about to send” 等“即将寄出”的表述。
- 只输出英文邮件正文（纯文本，不要 markdown，不要 JSON）。${actionExtraRules}${extraInstruction ? `\n${extraInstruction}` : ""}`;
