 ...
 *
 * 2026-09：门禁与「画像语言」统一使用同一套检测器（detectBioLanguageProfile），
 * 因此印尼语 / 越南语 / 土耳其语等非英语简介不再被误判成英语。
 */
