...
const taskRows = await queryTikTok(
  `SELECT payload, total_rows FROM tiktok_influencer_import_task WHERE id=97`
);
...
console.log(
  `TASK97 since=${cutoff} payload=${names.size} enrichUsers=${usersSeen} withItems=${usersWithItems} ` +
