    ...
    parameters: {
      ...
      properties: {
        ...
        contactMode: {
          ...
          description:
            "recommended_only=只联系符合campaign投放地区和红人画像要求且推荐的红人（默认）；contact_all=联系符合campaign投放地区的所有红人；do_not_contact=仅排重/不联系（不分析不联系，把名单写入全局不联系名单，用于避免重复触达）。必须在与用户确认模式后填写。",
        },
