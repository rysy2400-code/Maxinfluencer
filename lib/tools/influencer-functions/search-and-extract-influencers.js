  ...
  async function requestTiktokChromeRestart(endpointKey, reason) {
    ...
    try {
      ...
      const script =
        ...
        cfg.proxy +
        "','--no-first-run','--no-default-browser-check','--blink-settings=imagesEnabled=false','--autoplay-policy=user-gesture-required','https://www.tiktok.com/' -WindowStyle Hidden";
