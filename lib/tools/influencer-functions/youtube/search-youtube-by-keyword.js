...
import { closeDisposableCdpPage } from "../../../cdp/cdp-tab-utils.js";
...
export async function searchYoutubeByKeyword(params = {}, options = {}) {
  ...
  page = acquired.page;
  createdSearchTab = acquired.created;
  ...
  try {
    ...
    await closeDisposableCdpPage(page, { created: createdSearchTab });
    if (browser) {
      try {
