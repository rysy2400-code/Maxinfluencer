...
import { canSwitchAccounts, canSwitchToTarget } from "./account-switch.js";
...
async function buildAuthContextFromClaims(claims) {
  ...
  return {
    ...
    isCompanyAdmin: realUser.isCompanyAdmin,
  };
}
