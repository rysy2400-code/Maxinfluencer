...
$r = Invoke-CimMethod -ClassName Win32_Process -MethodName Create -Arguments @{ CommandLine = 'C:\maxinfluencer\config\worker-9225.cmd' }
Write-Host ("9225 worker pid=" + $r.ProcessId)
