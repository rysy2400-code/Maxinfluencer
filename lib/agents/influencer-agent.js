...
/** 首封邀约：红人账户平台（YouTube / Instagram / TikTok），用于 deliverables 筛选与称呼创作者 */
  ...
  const deliverablesRules = deliverablesEn
    ? (() => {
        ...
        return [
          ...
          `- **平台优先级（极其重要）**：以 JSON 中 **influencer.platform**（当前为 ${influencerPlatformLabel}）为准，判断该创作者属于 YouTube / Instagram / TikTok 哪一个。**忽略** campaign.platformLabel（${platformLabel}）里列出的其他投放平台——那只是整案多平台投放范围，不代表本邮件要写所有平台的要求。`,
