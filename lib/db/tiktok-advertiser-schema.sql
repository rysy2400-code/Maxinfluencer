...
CREATE TABLE IF NOT EXISTS tiktok_advertiser (
  ...
  balance_amount DECIMAL(14,4) NULL COMMENT '公司共享余额，NULL 视为 0',
  balance_currency VARCHAR(16) NULL DEFAULT 'USD' COMMENT '余额币种/单位，如 USD、POINT',
...
CREATE TABLE IF NOT EXISTS tiktok_advertiser_user (
  ...
  is_admin TINYINT(1) NOT NULL DEFAULT 0 COMMENT '1=平台管理员，可跨公司切换',
  is_company_admin TINYINT(1) NOT NULL DEFAULT 0 COMMENT '1=公司管理员，可切换本公司普通成员',
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
