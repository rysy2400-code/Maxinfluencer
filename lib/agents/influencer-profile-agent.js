...
提取用户提到的新要求，包括：
- followerRange（粉丝量范围）：例如 "10万-50万"、"50万-100万"
- viewRange（播放量范围）：例如 "10万-50万"、"50万-100万"
- accountType（账户类型）：例如 "美妆达人"、"时尚博主"、"生活方式KOL"、"产品测评"、"创意内容"

如果用户没有提到某项，该项为 null。

只返回 JSON 格式：
{
  "followerRange": "10万-50万" | null,
  "viewRange": "10万-50万" | null,
  "accountType": "美妆达人" | null
}`;
  ...
  async generateProfileRequirements(productInfo, campaignInfo, userRequirements = null) {
    const prompt = `基于以下信息，推荐合适的红人画像要求。
...
请推荐红人画像要求，包括：
1. followerRange（粉丝量范围）：例如 "10万-50万"、"50万-100万"、"100万-500万"
2. viewRange（播放量范围）：例如 "10万-50万"、"50万-100万"、"100万-500万"
3. accountType（账户类型）：例如 "美妆达人"、"时尚博主"、"生活方式KOL"、"产品测评"、"创意内容"、"科技数码"
