...
function normalizeSessionMessagesForRead(messages) {
  return sortSessionMessagesByTime(stripNonChatMessages(messages));
}
...
export async function updateCampaignSession(sessionId, updates) {
  try {
    ...
    if (updates.messages !== undefined) {
      ...
      const sanitizedMessages = normalizeSessionMessagesForStorage(
